...
const mustExist = [
  ...
  "e2e/execution-kernel-reload.spec.ts",
  "src/shared/executionPersistence.ts",
  "src/shared/telemetryRedact.ts",
  "scripts/golden-path-dogfood-setup.md",
  "src/renderer/features/workspace/executionRecord/LaunchReadinessBanner.tsx",
...
const exportChecks = [
  ...
  { file: "src/shared/shipReceipt.ts", needle: "buildShipReceiptFromApply" },
  { file: "src/shared/executionKernelBridge.ts", needle: "finalizeVerifyRun" },
  { file: "src/shared/shipQualityLint.ts", needle: "runShipQualityLint" },
  { file: "src/shared/doneWhenChecklist.ts", needle: "buildDoneWhenChecklist" },
  { file: "src/renderer/features/workspace/executionRecord/DoneWhenChecklistHeader.tsx", needle: "done-when-checklist" },
  { file: "src/renderer/features/workspace/executionRecord/ProofDetailView.tsx", needle: "proof-detail-view" },
  ...
  { file: "src/shared/executionPersistence.ts", needle: "assertSnapshotRoundTrip" },
  { file: "src/shared/telemetryRedact.ts", needle: "redactTelemetryProps" },
  { file: "src/renderer/features/workspace/executionRecord/LaunchReadinessBanner.tsx", needle: "launch-readiness-banner" },
  { file: "src/shared/cmoDelegateOperator.ts", needle: "buildDelegateSowMarkdown" },
  { file: "src/renderer/lib/analytics.ts", needle: "redactTelemetryProps" },
  { file: "e2e/execution-kernel-reload.spec.ts", needle: "@execution-kernel" },
