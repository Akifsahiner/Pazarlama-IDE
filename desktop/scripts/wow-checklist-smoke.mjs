...
const MARKERS = [
  ...
  ["src/shared/shipReceipt.ts", "shipReceiptToResultChips", "Faz 4 ship receipt SSOT"],
  ["src/shared/executionKernelBridge.ts", "finalizeVerifyRun", "Faz 4 verify bridge"],
  ["src/shared/shipQualityLint.ts", "runShipQualityLint", "Faz 4 quality lint"],
  ["src/shared/doneWhenChecklist.ts", "buildDoneWhenChecklist", "Faz 4 done-when checklist"],
  ["src/renderer/features/workspace/executionRecord/DoneWhenChecklistHeader.tsx", "done-when-checklist", "Faz 4 checklist UI"],
  ["src/renderer/features/workspace/executionRecord/ProofDetailView.tsx", "proof-detail-view", "Faz 4 proof tab"],
  ["../server/evals/ship-receipt-matrix.mjs", "ship-receipt-matrix", "Faz 4 eval matrix"],
  ["../server/evals/human-lane-matrix.mjs", "human-lane-matrix", "Faz 5 human lane eval matrix"],
  ["src/shared/humanExecutionAsset.ts", "HumanExecutionAsset", "Faz 5 human execution asset SSOT"],
  ["src/shared/buildHumanExecutionAsset.ts", "buildHumanExecutionAsset", "Faz 5 post kit builder"],
  ["src/shared/humanProofProgress.ts", "validatePostedUrl", "Faz 5 progressive proof gates"],
  ["src/renderer/features/workspace/executionRecord/HumanTaskKitDrawer.tsx", "human-task-kit-drawer", "Faz 5 post kit drawer"],
  ["src/renderer/features/workspace/executionRecord/DistributionHookDayGrid.tsx", "distribution-hook-day-grid", "Faz 5 distribution hook grid"],
  ["e2e/human-task-kit.spec.ts", "@human-lane", "Faz 5 human lane e2e"],
  ["src/shared/measurementPulse.ts", "evaluateDayPulse", "Faz 6 day pulse SSOT"],
  ["src/shared/hookLeaderboard.ts", "buildHookLeaderboard", "Faz 6 hook leaderboard"],
  ...
  ["src/renderer/features/workspace/executionRecord/SocialMetricsImportPanel.tsx", "social-metrics-import-panel", "Faz 6 social import panel"],
  ["src/renderer/state/store.ts", "importSocialMetrics", "Faz 6 social import store action"],
  ["../server/evals/proof-loop-matrix.mjs", "proof-loop-matrix", "Faz 6 proof loop eval matrix"],
  ["../CMO_DAY3_PULSE_SPEC.md", "Day 3 Pulse", "Faz 6 spec doc"],
  ["e2e/day-pulse.spec.ts", "@day-pulse", "Faz 6 day pulse e2e"],
