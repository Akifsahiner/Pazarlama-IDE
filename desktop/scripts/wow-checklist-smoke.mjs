...
const MARKERS = [
  ...
  ["src/shared/firstHourWow.ts", "resolveThesisFirstAction", "Faz 1 thesis-aware first hour"],
  ["src/renderer/features/onboarding/ProjectReveal.tsx", "reveal-your-game", "Faz 1 your game beat"],
  ["src/renderer/features/onboarding/ProjectReveal.tsx", "reveal-week0-primary", "Faz 1 Week 0 primary path"],
