...
export function OtherDownloads({ tone = "hero" }: { tone?: Tone }) {
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <p className={tone === "hero" ? "hero-other-downloads__label" : "text-[12px] text-ink-3"}>
        Also available for
      </p>
      <div className={tone === "hero" ? "hero-other-downloads" : "flex flex-wrap items-center justify-center gap-2"}>
        {others.map((opt) => (
        ...
        <Link
          href="/download"
          className={tone === "hero" ? "hero-other-downloads__link" : "text-[12px] text-ink-3 underline-offset-2 hover:text-ink hover:underline"}
        >
          All builds
        </Link>
      </div>
      {platform === "unknown" && (
        <a
          href={RELEASE_LATEST}
          className={tone === "hero" ? "hero-other-downloads__hint" : "text-[11px] text-ink-3 hover:text-ink"}
        >
