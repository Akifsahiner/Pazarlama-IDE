...
- **Don't:** Start with logo, intro music, or "Welcome to our channel." **Why:** 80% swipe before second 2. Hook first; branding comes after you've earned attention.
- **Don't:** Post horizontal screen recordings with black bars. **Why:** Algorithm deprioritizes non-native aspect ratio. Reframe to 9:16 or use picture-in-picture with face cam.
- **Don't:** Cram 5 features into one 30-second video. **Why:** Zero retention past feature 2. One hook, one payoff, one CTA per clip.
- **Don't:** Skip captions. **Why:** Most mobile viewing is muted. No captions = no message for majority of viewers.
