# Playbook: Aggressive Hook Lab

Hook bank + retention curve + platform algo notes

## Preconditions
- [ ] Marketing profile complete for short-form-video
...
| aggressive | Strong assets + clear ICP | Hook bank + retention curve + platform algo notes |
