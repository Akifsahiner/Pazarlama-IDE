# Playbook: Aggressive Positioning Wedge from Repo

Scan → competitive moat; repo-grounded only
...
| aggressive | Strong assets + clear ICP | Scan → competitive moat; repo-grounded only |
