# Case study: Fake GA4 avoided — manual KPI week 1 (anonymous)

## Context
Operator applied **analytics-measurement** with real profile constraints — no invented metrics.
...
## Lesson
Aggressive intensity without assets fails — state ceiling early.
